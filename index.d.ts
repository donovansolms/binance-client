...
declare module 'binance-client-combined-ws' {
  ...
  export interface Binance {
    ...
    myTrades(
      options: { symbol: string; limit?: number; fromId?: number; useServerTime?: boolean },
      agent?: Agent,
    ): Promise<MyTrade[]>
    getOrder(
      options: {
    ...
    tradesHistory(
      options: { symbol: string; limit?: number; fromId?: number },
      agent?: Agent,
    ): Promise<Trade[]>
    depositAddress(options: { asset: string }, agent?: Agent): Promise<DepositAddress>
    withdraw(
      options: { asset: string; address: string; amount: number; name?: string },
      agent?: Agent,
    ): Promise<WithrawResponse>
    assetDetail(agent?: Agent): Promise<AssetDetail>
    withdrawHistory(
      options: { asset: string; status?: number; startTime?: number; endTime?: number },
      agent?: Agent,
    ...
    futuresBook: (
      payload: { symbol: string; limit?: number; recvWindow?: number },
      agent?: Agent,
    ) => Promise<FOrderBook>
    futuresTrades: (
      payload: { symbol: string; limit?: number; recvWindow?: number },
    ...
    futuresTradesHistory: (
      payload: { symbol: string; limit?: number; fromId?: number; recvWindow?: number },
      agent?: Agent,
    ) => Promise<FTrade[]>
    futuresAggTrades: (
      payload: {
      ...
      agent?: Agent,
    ) => Promise<FAggregatedTrade[]>
    futuresCandles: (
      payload: FCandlesOptions & { recvWindow?: number },
      agent?: Agent,
    ) => Promise<FCandleChartResult[]>
    // ______________ futures exclusive
    futuresChangePositionMode: (
      payload: { dualSidePosition: boolean; recvWindow?: number },
      agent?: Agent,
    ) => Promise<{ code: number; msg: string }>
    futuresGetPositionMode: (
      payload: { recvWindow?: number },
      agent?: Agent,
    ) => Promise<{ dualSidePosition: boolean }>
    futuresMarkPrice: (
      payload: { symbol?: string; recvWindow?: number },
      agent?: Agent,
    ) => Promise<FMarkPrice>
    futuresFundingRate: (
      payload: {
      ...
      agent?: Agent,
    ) => Promise<FFundingRate>
    futuresDailyStats: (
      payload: { symbol?: string; recvWindow?: number },
      agent?: Agent,
    ) => Promise<FDailyState>
    futuresPrice: (
      payload: { symbol?: string; reduce?: boolean; recvWindow?: number },
      agent?: Agent,
    ) => Promise<FPrice | FPrice[] | FReducedPrice>
    ...
    futuresBookTicker: (
      payload: { symbol?: string; reduce?: boolean; recvWindow?: number },
      agent?: Agent,
    ) => Promise<FBookTicker | FBookTicker[] | FReducedBookTicker>
    futuresAllForceOrders: (
      ...
      agent?: Agent,
    ) => Promise<FForceOrder | FForceOrder[]>
    futuresOpenInterest: (
      payload: { symbol: string; recvWindow?: number },
      agent?: Agent,
    ) => Promise<FOpenInterest>
    futuresLeverageBracket: (
      payload: { symbol?: string; recvWindow?: number },
      agent?: Agent,
    ) => Promise<FLeverageBrackets | FLeverageBrackets[] | FReducedLeverageBrackets>
    futuresAccountTransfer: (
      payload: { asset: string; amount: number; type: number; recvWindow?: number },
      agent?: Agent,
    ) => Promise<FAccountTransfer>
    futuresAccountTransactionHistory: (
      payload: {
        asset: string
        startTime: number
        endTime?: number
      ...
      agent?: Agent,
    ) => Promise<FAccountTransferHistory>
    futuresOrder: (
      payload: FNewOrder & { recvWindow?: number },
      agent?: Agent,
    ) => Promise<FOrder | HttpError>
    futuresOrderTest: (
      payload: { symbol?: string; recvWindow?: number },
      agent?: Agent,
    ) => Promise<FMarkPrice>
    futuresBatchOrders: (
      payload: { batchOrders: FNewOrder[]; recvWindow?: number },
      agent?: Agent,
    ) => Promise<(FOrder | HttpError)[]>
    futuresGetOrder: (
      payload: {
    ...
    futuresCancelAllOpenOrders: (
      payload: { symbol: string; recvWindow?: number },
      agent?: Agent,
    ) => Promise<FCancelAllOrderResp>
    futuresCancelMultipleOrders: (
      payload: {
        symbol: string
        orderIdList?: number[]
        origClientOrderIdList?: number[]
        recvWindow?: number
      },
      agent?: Agent,
    ) => Promise<(FOrder | HttpError)[]>
    futuresCountDownCancelAllOrders: (
      payload: { symbol: string; countdownTime: number; recvWindow?: number },
      agent?: Agent,
    ) => Promise<FCancelAllOrderResp>
    futuresGetOpenOrder: (
      payload: {
    ...
    futuresAccountBalance: (
      payload: { recvWindow?: number },
      agent?: Agent,
    ) => Promise<FAccountBalance[]>
    futuresAccountInfo: (payload: { recvWindow?: number }, agent?: Agent) => Promise<FAccountInfo>
    futuresChangeLeverage: (
      payload: { symbol: string; leverage: number; recvWindow?: number },
      agent?: Agent,
    ) => Promise<FLeverageChangeResp>
    futuresChangeMarginType: (
      payload: { symbol: string; marginType: FMarginType; recvWindow?: number },
      agent?: Agent,
    ) => Promise<CodeMsgResp>
    futuresModifyPositionMargin: (
      payload: { symbol: string; amount: number; type: number; recvWindow?: number },
      agent?: Agent,
    ) => Promise<FModifyPositionMarginResp>
    futuresPositionMarginHistory: (
      ...
      agent?: Agent,
    ) => Promise<FPositionMargin[]>
    futuresPositionRisk: (
      payload: { recvWindow?: number },
      agent?: Agent,
    ) => Promise<FPositionRisk[]>
    futuresUserTrades: (
      payload: {
        symbol: string
        startTime?: number
  ...
  export interface IBinanceWebSocket {
    ...
    aggTrades: (
      ...
      callback: (trade: WsAggregatedTrade) => void,
    ) => StreamReturnObj
    user: (
      callback: (msg: OutboundAccountInfo | ExecutionReport) => void,
    ) => Promise<StreamReturnObj>
  }
  ...
  export interface IFuturesWebSocket {
    ...
    user: (
      callback: (
        msg:
          | FWSUserOrderUpdateData
          | FWSUserAccountUpdateData
          | FWSUserMarginCallEventData
          | { eventType: string; [prop: string]: any },
      ) => void,
    ) => Promise<FStreamReturnObj>
  ...
  export type FMarginType = 'ISOLATED' | 'CROSSED'
  ...
  export type FOrderWorkingType = 'MARK_PRICE' | 'CONTRACT_PRICE'
